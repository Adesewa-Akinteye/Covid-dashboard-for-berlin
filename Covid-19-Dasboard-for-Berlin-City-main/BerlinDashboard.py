...
def run():
    ...
    img = Image.open('pexels-edward-jenner-4031867.jpg')
    st.image(img)
    st.title('Covid-19 Report Dashboard for Berlin City')

    link = '[©Developed by Adesewa](www.linkedin.com/in/sewa-akinteye)'
...
st.write('''
    Dashboard created by [Sewa](hwww.linkedin.com/in/sewa-akinteye), with [Streamlit](https://www.streamlit.io).
